...
<head>
    ...
    <link rel="stylesheet" href="../../public/assets/css/css_inscription/style.css">
</head>
...
<body id="home">
    ...
    <header class="headerDesk">
        <div id="headerEffect" class="baseEffect">
        </div>
        <div class="nav">
            <div class="navbar">
                <ul class="navList">
            ...
            <div class="login">
                <p id="connection" class="animated connection">Connexion</p>
            </div>
        </div>
    </header>